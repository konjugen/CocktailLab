package md503d368792e76997a708abd586ec33284;


public class ShakeCocktailActivity
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CocktailLab.ShakeCocktailActivity, CocktailLab, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ShakeCocktailActivity.class, __md_methods);
	}


	public ShakeCocktailActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ShakeCocktailActivity.class)
			mono.android.TypeManager.Activate ("CocktailLab.ShakeCocktailActivity, CocktailLab, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
